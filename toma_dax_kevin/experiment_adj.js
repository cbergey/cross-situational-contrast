    ...
    */
    ...
    var debrief = {
        ...
        + "<p></p><p class='block-text-debrief'>"
        + "This experiment is an investigation of how adjective description affects people's representations of categories. "
        + "In this case, we are looking to see if participants infer that a described feature (e.g. \"big " + distractorName + "\") is atpyical. "
        + "If so, participants should treat these big " + distractorName + "s as unusual even if they see many of them, "
        + "and categorize smaller " + distractorName + "s more accurately and quickly.</p>"
